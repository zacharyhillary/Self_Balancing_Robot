...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="C:/Users/Zachary/Desktop/SelfBalancingRobotWorkspace/SelfBalancingRobot" --include_path="C:/Users/Zachary/Desktop/SelfBalancingRobotWorkspace/SelfBalancingRobot" --include_path="C:/ti/tirtos_tivac_2_16_01_14/products/TivaWare_C_Series-2.1.1.71b" --include_path="C:/ti/tirtos_tivac_2_16_01_14/products/bios_6_45_02_31/packages/ti/sysbios/posix" --include_path="C:/ti/ccs1040/ccs/tools/compiler/ti-cgt-arm_20.2.5.LTS/include" --define=ccs="ccs" --define=PART_TM4C123GH6PM --define=ccs --define=TIVAWARE -g --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-1969119697:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1969119697-inproc

build-1969119697-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1969119697 ../empty.cfg
configPkg/compiler.opt: build-1969119697
configPkg/: build-1969119697
